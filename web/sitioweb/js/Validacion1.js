...
$(document).ready(function() {
    ...
    $("#citar").click(function() {
        ...
        if (numeroDocumento === "" || numeroDocumento === null) {
            ...
            document.getElementById('cedula').setAttribute('data-original-title', 'Debe ingresar su número de documento');
            $(document).ready(function() {
                // Initialize tooltip
            ...
            document.getElementById('cedula').setAttribute('data-toggle', 'tooltip');
            document.getElementById('cedula').setAttribute('data-original-title', 'Debe ingresar sólo números, no se admiten letras');
            $(document).ready(function() {
                // Initialize tooltip
                $('[data-toggle="tooltip"]').tooltip({
                    placement: 'left'
            ...
            document.getElementById('cedula').setAttribute('data-toggle', 'tooltip');
            document.getElementById('cedula').setAttribute('data-original-title', 'Debe ser de 10 digitos el campo');
            $(document).ready(function() {
                // Initialize tooltip
                $('[data-toggle="tooltip"]').tooltip({
                    placement: 'left'
            ...
            document.getElementById('cedula').removeAttribute('data-original-title', 'Este campo no debe ir vacio');
        ...
        if (rol.selectedIndex === 0) {
            ...
            document.getElementById('citar').setAttribute('disabled', 'true');
        } else {
            ...
            document.getElementById('citar').removeAttribute('disabled');
        }
...
function validarRol(rol) {
    if (rol.selectedIndex === 0) {
        document.getElementById('odontologo').setAttribute('data-toggle', 'tooltip');
        document.getElementById('odontologo').setAttribute('data-original-title', 'Seleccione un odontologo');
        $(document).ready(function() {
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
            });
        ...
        document.getElementById('odontologo').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('odontologo').removeAttribute('data-original-title', 'Debe selecciona un rol');
        document.getElementById('inpRol').setAttribute('class', 'form-group has-success');
...
function validarDocumento(numeroDocumento) {
    ...
    if (numeroDocumento.value === "" || numeroDocumento.value === null) {
        document.getElementById('cedula').setAttribute('data-toggle', 'tooltip');
        document.getElementById('cedula').setAttribute('data-original-title', 'Digite el numero documento');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('cedula').setAttribute('data-toggle', 'tooltip');
        document.getElementById('cedula').setAttribute('data-original-title', 'Este campo es numerico');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('cedula').setAttribute('data-toggle', 'tooltip');
        document.getElementById('cedula').setAttribute('data-original-title', 'Debe ser de minimo 8 digitos el campo');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('cedula').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('cedula').removeAttribute('data-original-title', 'Este campo no puede estar vacio');
        document.getElementById('inpDocumento').setAttribute('class', 'form-group has-feedback has-success');
       

    }
}
function validarDocumentos(numeroDocumentos) {

      if (isNaN(numeroDocumento.value)) {
        document.getElementById('documento').setAttribute('data-toggle', 'tooltip');
        document.getElementById('documento').setAttribute('data-original-title', 'Este campo es numerico');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('documento').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('documento').removeAttribute('data-original-title', 'Este campo no puede estar vacio');
        document.getElementById('inpDocumento').setAttribute('class', 'form-group has-feedback has-success');
...
function validarNombres(campoNombres) {
    ...
    if (campoNombres.value === null || campoNombres.value === "") {
        document.getElementById('observacion').setAttribute('data-toggle', 'tooltip');
        document.getElementById('observacion').setAttribute('data-original-title', 'El campo no puede estar vacio');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        return false;
    } else if (campoNombres.value.length <6) {
        document.getElementById('observacion').setAttribute('data-toggle', 'tooltip');
        document.getElementById('observacion').setAttribute('data-original-title', 'El mensaje debe contener mas de 6 caracteres');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'left'
        ...
        document.getElementById('observacion').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('observacion').removeAttribute('data-original-title', 'El nombre no puede ser un número');
...
function validarApellidos(campoApellidos) {
 ...
 if (!(/^[a-zA-Z-ZáéíóúàèìòùÀÈÌÒÙÁÉÍÓÚñÑüÜñÑ ]+$/.test(campoApellidos.value))) {
        document.getElementById('ruApellidos').setAttribute('data-toggle', 'tooltip');
        document.getElementById('ruApellidos').setAttribute('data-original-title', 'Este campo solo acepta letras');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'left'
        ...
        document.getElementById('ruApellidos').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('ruApellidos').removeAttribute('data-original-title', 'Este campo solo acepta letras');
        document.getElementById('inpApellidos').setAttribute('class', 'form-group has-feedback has-success');
...
function validarNombre(campoNombre) {
      ...
      if (!(/^[a-zA-Z-ZáéíóúàèìòùÀÈÌÒÙÁÉÍÓÚñÑüÜñÑ ]+$/.test(campoNombre.value))) {
        document.getElementById('nombre').setAttribute('data-toggle', 'tooltip');
        document.getElementById('nombre').setAttribute('data-original-title', ' Este campo solo hacepta letras');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('nombre').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('nombre').removeAttribute('data-original-title', 'Este campo solo hacepta letras');
        document.getElementById('inpNombres').setAttribute('class', 'form-group has-feedback has-success');
...
function validarHora(hora) {
    if (hora.value === null || hora.value === "") {
        document.getElementById('turno').setAttribute('data-toggle', 'tooltip');
        document.getElementById('turno').setAttribute('data-original-title', 'Seleccione una hora');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'right'
        ...
        document.getElementById('turno').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('turno').removeAttribute('data-original-title');
        document.getElementById('inpCiudad').setAttribute('class', 'form-group has-feedback has-success');
        document.getElementById('citar').removeAttribute('disabled');
    }
}
