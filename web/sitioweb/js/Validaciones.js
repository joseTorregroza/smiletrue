...
function validarNombres(campoNombres) {
    ...
    if (campoNombres.value === null || campoNombres.value === "") {
        document.getElementById('user').setAttribute('data-toggle', 'tooltip');
        document.getElementById('user').setAttribute('data-original-title', 'El campo no puede estar vacio');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'left'
        ...
        document.getElementById('btnIngresar').setAttribute('disabled', 'true');
    } else if (!isNaN(campoNombres.value)) {
        document.getElementById('user').setAttribute('data-toggle', 'tooltip');
        document.getElementById('user').setAttribute('data-original-title', 'El nombre no puede ser un número');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'left'
        ...
        document.getElementById('user').setAttribute('data-toggle', 'tooltip');
        document.getElementById('user').setAttribute('data-original-title', 'Tienen que ser más de 3 carácteres');
        $(document).ready(function() {
            // Initialize tooltip
            $('[data-toggle="tooltip"]').tooltip({
                placement: 'left'
        ...
        document.getElementById('user').removeAttribute('data-toggle', 'tooltip');
        document.getElementById('user').removeAttribute('data-original-title', 'El nombre no puede ser un número');
